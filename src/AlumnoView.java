...
public class AlumnoView extends JFrame{
    ...
    public AlumnoView(String userID) {
        ...
        rentar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (selectedRow == -1) {
                    JOptionPane.showMessageDialog(AlumnoView.this, "No se seleccionó ningún ejemplar", "Error", JOptionPane.ERROR_MESSAGE);
                    return;
                }

                String daysInput = JOptionPane.showInputDialog(AlumnoView.this, "Ingrese el número de días para alquilar:");
                ...
                try {
                    ...
                    if (daysToRent <= 0) {
                        JOptionPane.showMessageDialog(AlumnoView.this, "Ingrese un número de días válido", "Error", JOptionPane.ERROR_MESSAGE);
                        return;
                    }
                    ...
                    JOptionPane.showMessageDialog(AlumnoView.this, "Ingrese un número válido para los días", "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        });
